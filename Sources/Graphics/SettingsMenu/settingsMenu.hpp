...
namespace graphic
{
    ...
    private:
        ...
        const std::unordered_map <graphic::controllerUser, std::function<void(graphic::IrrlichtLib&)>> _eventTab =
                {
                        {graphic::BRIGTHNESS_DOWN, [](graphic::IrrlichtLib &_lib){ _lib.modifyLight(-1); }},
                        {graphic::BRIGTHNESS_UP, [](graphic::IrrlichtLib &_lib){ _lib.modifyLight(1); }},
                        //{graphic::SOUND_DOWN, modifySound},
                        //{graphic::SOUND_UP, modifySound},
